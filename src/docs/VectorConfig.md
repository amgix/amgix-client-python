...
**index_fields** | **List[str]** | List of fields to index with this vector (name, description, content). Defaults to [&#39;content&#39;] if not specified. Mutually exclusive with doc_template/query_template. | [optional] 
**doc_template** | **str** | Document text template with placeholders {name}, {description}, {content}, {.meta.&lt;key&gt;}. Requires query_template; mutually exclusive with index_fields. | [optional] 
**query_template** | **str** | Query text template with exactly one {query} placeholder. Requires doc_template; mutually exclusive with index_fields. | [optional] 
