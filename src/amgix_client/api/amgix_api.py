...
class AmgixApi:
    ...
    async def delete_document(
        ...
        request_timestamp: Annotated[datetime, Field(description="Caller-supplied delete timestamp (UTC)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param request_timestamp: Caller-supplied delete timestamp (UTC) (required)
        ...
        if request_timestamp is not None:
            if isinstance(request_timestamp, datetime):
                _query_params.append(
                    (
                        'request_timestamp',
                        request_timestamp.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('request_timestamp', request_timestamp))
    ...
    async def delete_document_sync(
        ...
        _param = self._delete_document_sync_serialize(
            collection_name=collection_name,
            document_id=document_id,
            request_timestamp=request_timestamp,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def delete_document_sync_with_http_info(
        self,
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        document_id: StrictStr,
        request_timestamp: Annotated[datetime, Field(description="Caller-supplied delete timestamp (UTC)")],
    ...
    @validate_call
    async def delete_document_sync_without_preload_content(
        self,
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        document_id: StrictStr,
        request_timestamp: Annotated[datetime, Field(description="Caller-supplied delete timestamp (UTC)")],
    ...
    def _delete_document_sync_serialize(
        self,
        collection_name,
        document_id,
        request_timestamp,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/collections/{collection_name}/documents/{document_id}/sync',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def export_documents(
        self,
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        with_vectors: Annotated[Optional[StrictBool], Field(description="When true, include stored vector values on each exported document.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param collection_name: Collection name (alphanumeric, underscores, hyphens only) (required)
        :type collection_name: str
        :param with_vectors: When true, include stored vector values on each exported document.
        :type with_vectors: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _export_documents_serialize(
        ...
        if with_vectors is not None:
            ...
            _query_params.append(('with_vectors', with_vectors))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/collections/{collection_name}/documents/export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def fetch_documents(
        ...
        :param collection_name: Collection name (alphanumeric, underscores, hyphens only) (required)
        :type collection_name: str
        :param document_fetch_request: (required)
        :type document_fetch_request: DocumentFetchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    @validate_call
    async def fetch_documents_with_http_info(
        self,
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        document_fetch_request: DocumentFetchRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentFetchResponse]:
        """Fetch Documents
    ...
    @validate_call
    async def fetch_documents_without_preload_content(
        self,
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        document_fetch_request: DocumentFetchRequest,
        _request_timeout: Union[
    ...
    def _fetch_documents_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if document_fetch_request is not None:
            _body_params = document_fetch_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/collections/{collection_name}/documents/fetch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_collection_stats(
        ...
        _param = self._get_collection_stats_serialize(
            collection_name=collection_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_collection_stats_with_http_info(
        self,
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CollectionStatsResponse]:
        """Get Collection Stats
    ...
    @validate_call
    async def get_collection_stats_without_preload_content(
        self,
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        _request_timeout: Union[
            None,
    ...
    def _get_collection_stats_serialize(
        self,
        collection_name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/collections/{collection_name}/stats',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_document(
        ...
        collection_name: Annotated[str, Field(min_length=1, strict=True, max_length=100, description="Collection name (alphanumeric, underscores, hyphens only)")],
        document_id: StrictStr,
        with_vectors: Annotated[Optional[StrictBool], Field(description="When true, include stored vector values on the document.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param document_id: (required)
        :type document_id: str
        :param with_vectors: When true, include stored vector values on the document.
        :type with_vectors: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    async def metrics_current(
        self,
        window: Annotated[Optional[StrictInt], Field(description="Aggregation window in seconds - 30 or 60.")] = None,
        keys: Annotated[Optional[List[StrictStr]], Field(description="Restrict returned metric series to these keys. Omit for all keys.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param window: Aggregation window in seconds - 30 or 60.
        :type window: int
        :param keys: Restrict returned metric series to these keys. Omit for all keys.
        :type keys: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._metrics_current_serialize(
            window=window,
            keys=keys,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def metrics_current_with_http_info(
        self,
        window: Annotated[Optional[StrictInt], Field(description="Aggregation window in seconds - 30 or 60.")] = None,
        keys: Annotated[Optional[List[StrictStr]], Field(description="Restrict returned metric series to these keys. Omit for all keys.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def metrics_current_without_preload_content(
        self,
        window: Annotated[Optional[StrictInt], Field(description="Aggregation window in seconds - 30 or 60.")] = None,
        keys: Annotated[Optional[List[StrictStr]], Field(description="Restrict returned metric series to these keys. Omit for all keys.")] = None,
        _request_timeout: Union[
    ...
    def _metrics_current_serialize(
        self,
        window,
        keys,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/metrics/current',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def metrics_definitions(
        ...
        _param = self._metrics_definitions_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def metrics_definitions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[MetricDefinitionItem]]:
        """Metrics Definitions
    ...
    @validate_call
    async def metrics_definitions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _metrics_definitions_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/metrics/definitions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def metrics_prometheus(
        ...
        _param = self._metrics_prometheus_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def metrics_prometheus_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def metrics_prometheus_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _metrics_prometheus_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/metrics/prometheus',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def metrics_trends(
        self,
        since: Annotated[datetime, Field(description="Inclusive start of the time range (ISO 8601)")],
        until: Annotated[datetime, Field(description="Exclusive end of the time range (ISO 8601)")],
        resolution: Annotated[Optional[StrictInt], Field(description="Bucket size in seconds - 60 for 1-minute, 300 for 5-minute.")] = None,
        ...
        :param since: Inclusive start of the time range (ISO 8601) (required)
        :type since: datetime
        :param until: Exclusive end of the time range (ISO 8601) (required)
        :type until: datetime
        :param resolution: Bucket size in seconds - 60 for 1-minute, 300 for 5-minute.
        :type resolution: int
        :param keys:
        :type keys: List[str]
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._metrics_trends_serialize(
            since=since,
            until=until,
    ...
    @validate_call
    async def metrics_trends_with_http_info(
        self,
        since: Annotated[datetime, Field(description="Inclusive start of the time range (ISO 8601)")],
        until: Annotated[datetime, Field(description="Exclusive end of the time range (ISO 8601)")],
        resolution: Annotated[Optional[StrictInt], Field(description="Bucket size in seconds - 60 for 1-minute, 300 for 5-minute.")] = None,
    ...
    @validate_call
    async def metrics_trends_without_preload_content(
        self,
        since: Annotated[datetime, Field(description="Inclusive start of the time range (ISO 8601)")],
        until: Annotated[datetime, Field(description="Exclusive end of the time range (ISO 8601)")],
        resolution: Annotated[Optional[StrictInt], Field(description="Bucket size in seconds - 60 for 1-minute, 300 for 5-minute.")] = None,
    ...
    def _metrics_trends_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/metrics/trends',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def system_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def system_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
