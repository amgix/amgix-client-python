...
class VectorSearchOption(BaseModel):
    ...
    var_field: Optional[StrictStr] = Field(default=None, description="Field to search with this vector (name, description, content). Optional for template-based vectors (ignored if present).", alias="field")
