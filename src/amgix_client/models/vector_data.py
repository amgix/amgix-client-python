...
class VectorData(BaseModel):
    ...
    var_field: StrictStr = Field(description="Field this vector is for (name, description, content, or template)", alias="field")
    ...
    def var_field_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['name', 'description', 'content', 'template']):
            raise ValueError("must be one of enum values ('name', 'description', 'content', 'template')")
        return value
