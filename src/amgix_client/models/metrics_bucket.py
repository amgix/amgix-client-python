...
class MetricsBucket(BaseModel):
    ...
    hostname: Optional[StrictStr] = Field(default=None, description="Reporting node hostname (historical buckets only)")
    source: Optional[StrictStr] = Field(default=None, description="Reporting node source, e.g. api or index (historical buckets only)")
    __properties: ClassVar[List[str]] = ["key", "dims", "bucket_start", "bucket_seconds", "value", "n", "hostname", "source"]
